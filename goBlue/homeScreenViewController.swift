...
class homeScreenViewController: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        if (PFUser.currentUser() != nil){
            let viewController:UIViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier("rootView") as! UIViewController
    ...
    override func viewDidLoad() {
            ...
            loginBtn = UIButton(frame: CGRectMake(40, 360, 240, 40))
